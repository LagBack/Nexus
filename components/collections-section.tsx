    ...
    <section className="py-20 lg:py-32 bg-secondary/30" id="colecoes">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-mono font-bold text-foreground tracking-tight text-balance">
            Nossas Colecoes
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="relative">
            ...
            {/* Variant Badge */}
            <div className="absolute top-4 left-4 bg-background/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium border border-border">
          ...
          <div className="flex flex-col">
            <div className="mb-8">
              <h3 className="text-2xl lg:text-3xl font-mono font-bold text-foreground mb-2">
            ...
            <div className="grid grid-cols-3 gap-3 mb-8">
              {currentCollection.images.map((image, index) => (
                <button
                  ...
                  className={`aspect-square bg-[#e8e4df] rounded-lg overflow-hidden border-2 transition-all duration-200 ${
        ...
        {/* All Images Gallery */}
        <div className="mt-20">
          <h3 className="text-xl font-mono font-bold text-foreground mb-6 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {currentCollection.images.map((image, index) => (
              <button
                key={index}
                onClick={() => setActiveImageIndex(index)}
                className="group relative aspect-square bg-[#e8e4df] rounded-xl overflow-hidden border border-border hover:border-foreground transition-all duration-300"
              >
                <Image
                  src={image.src}
                  alt={image.alt}
