      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-mono font-bold tracking-tight text-foreground leading-[1.1] text-balance mb-6">
              O Futuro do
              <span className="block">Streetwear</span>
            </h1>
            <p className="text-muted-foreground text-lg lg:text-xl max-w-md mx-auto lg:mx-0 mb-8">
              Design inovador encontra tecnologia de ponta. Descubra tênis que redefinem o conceito de estilo.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" className="bg-foreground text-background hover:bg-foreground/90 font-medium px-8">
                Explorar Coleção
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button size="lg" variant="outline" className="border-border hover:bg-secondary font-medium px-8">
                Ver Lançamentos
              </Button>
            </div>
